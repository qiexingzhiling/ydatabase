...
fn test_engine_get() {
    ...
    assert_eq!(Errors::KeyIsNotExist, res3.err().unwrap());
    ...
    assert_eq!(Errors::KeyIsNotExist, res9.err().unwrap());
    ...
    assert_eq!(Errors::KeyIsNotExist, res13.err().unwrap());
...
fn test_engine_delete() {
    ...
    assert_eq!(Errors::KeyIsNotExist, res10.err().unwrap());
