...
mod tests {
    ...
    fn test_write_batch1() {
        ...
        let wb=engine.new_write_batch(WriteBatchOptions::default()).expect("fail to create write batch");
        let res1=wb.put(util::rand_kv::get_test_key(1),util::rand_kv::get_test_value(10));
        assert!(res1.is_ok());
        let res2=wb.put(util::rand_kv::get_test_key(2),util::rand_kv::get_test_value(10));
        assert!(res2.is_ok());
    ...
    fn test_write_batch3() {
        ...
        let wb=engine.new_write_batch(wb_opts).expect("fail to create write batch");
        for i in 0..100000 {
